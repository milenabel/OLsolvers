...
class GeneralSolver:
    ...
    def solve(self):
        ...
        # Define f using UFL
        f_expr = -div(grad(p_exact_expr))

        # Convert f to a Dolfinx function in the function space V
        f = fem.Function(V)
        ...
        # Save solution as XDMF for visualization
        ...
        # Save dataset as JSON for DeepONet
