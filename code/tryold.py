...
params = model.init(key, x_train[0:1], a_train[0:1] if a_train[0:1] is not None else x_train[0:1])
...
# Save results
if solution_type == "manufactured":
    results_filename = f"../results/deeponets/2/deeponet_o_results_{solution_type}.json"
elif solution_type == "FEM":
    results_filename = f"../results/deeponets/2/deeponet_o_results_{solution_type}.json"
